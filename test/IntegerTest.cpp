...
TEST(IntegerTest, TestAddition1) {
    Integer i1(0), i2(0);
    Integer expected(0), actual = i1 + i2;
...
TEST(IntegerTest, TestAddition4) {
    Integer i1(5000), i2(5000);
    Integer expected(10000), actual = i1 + i2;
...
TEST(IntegerTest, TestMultiplication2) {
    Integer i1(-50), i2(50);
    Integer expected(-2500), actual = i1 * i2;
...
TEST(IntegerTest, TestDivision2) {
    Integer i1(-50), i2(50);
    Integer expected(-1), actual = i1 / i2;
...
TEST(IntegerTest, TestDivision6) {
    ...
    Integer expected(-50), actual = i1 / i2;
